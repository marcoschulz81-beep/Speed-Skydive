...
VALIDATION_WINDOW_VERTICAL_DROP_M = 1006.0
SCORING_WINDOW_DURATION_S = 3.0
SCORING_GRID_STEP_S = 0.1

MIN_SAMPLE_RATE_HZ = 5.0
MAX_SACC_MPS = 3.0
MIN_NUM_SV = 6

DEFAULT_BREAKOFF_ALTITUDE_AGL_M = 1707.0
NEGATIVE_RISK_LOOKBACK_S = 1.2
...
MAX_UPLOAD_BYTES = max(1, _env_int("MAX_UPLOAD_BYTES", 25 * 1024 * 1024))
